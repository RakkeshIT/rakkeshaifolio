      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="text-gray-500 mt-4 max-w-2xl mx-auto">
            Professional experience building scalable full-stack
            applications and delivering real-world technical solutions.
          </p>
        </div>
        ...
        <div className="relative border-l border-gray-200 pl-8 space-y-16">
          ...
          <div className="relative">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl shadow-sm hover:shadow-lg transition">
              ...
              <ul className="space-y-3 text-gray-700 leading-relaxed">
                <li>
                  • Contributing to development of a scalable CRM
                ...
                <li>
                  • Optimized MongoDB queries and improved backend
                  performance.
                </li>
                <li>
                  • Debugged production issues and enhanced system
                  stability.
                </li>
                <li>
                  • Collaborated with frontend teams for seamless
                  API integration.
                </li>
              </ul>
          ...
          <div className="relative">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl shadow-sm hover:shadow-lg transition">
              ...
              <ul className="space-y-3 text-gray-700 leading-relaxed">
                <li>
                  • Delivered training sessions on Full Stack
                  Development to 100+ students.
                </li>
                <li>
                  • Designed project-based curriculum covering
                  authentication, APIs, and database systems.
                </li>
                <li>
                  • Mentored students in building production-ready
                  applications.
                </li>
              </ul>
